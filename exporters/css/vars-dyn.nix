...
let
  ...
  mkSurfaceColor = c: "calc(var(--stl-global-surface-hue_offset) + ${toString c.h}), calc(var(--stl-global-surface-sat_scale) * ${toString c.s}%), calc(var(--stl-global-surfacle-light_scale) * ${toString c.l}%)";
